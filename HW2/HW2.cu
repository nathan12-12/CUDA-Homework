...
// Allocating the memory we will be using. This is step 1
void allocateMemory()
{	
	// Host "CPU" memory.				
...
// This is step 3 call the GPU using the __global__ keyword
...
int main()
{
	...
	{
		printf("\n\n You added the two vectors with the size of %d correctly on the GPU", N);
